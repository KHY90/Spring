...
public class FirstController {
    ...
    public ModelAndView modifyMenuAll(ModelAndView mv,
                                      // http 는 텍스트로 정보를 주고 받기 때문에 무조건 String으로 받아야한다.
     ...
     * */
    @PostMapping("login1")
    public String sesstionTest1(HttpSession session, @RequestParam String id) {
    ...
    public String logoutText2(SessionStatus sessionStatus) {
        sessionStatus.setComplete(); // 모든 세션을 제거
        return "first/loginResult";
    }
