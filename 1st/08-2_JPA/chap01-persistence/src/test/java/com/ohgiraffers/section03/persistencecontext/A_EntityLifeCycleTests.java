...
public class A_EntityLifeCycleTests {
    ...
    * */
    ...
    public void 비영속성_테스트(){
        ...
        newMenu.setMenuCdoe(foundMenu.getMenuCdoe());
    ...
    public void 준영속성_clear_테스트() {
        ...
        assertNotEquals(5000, entityManager.find(Menu.class, 12).getMenuPrice());
    }
    ...
    public void 삭제_remove_테스트() {
        ...
        //then
        Assertions.assertEquals(2, foundMenu.getMenuCdoe());
    ...
    public void 병합_merge_삽입_테스트() {
        ...
        //when
        menuToDetach.setMenuCdoe(999);         // DB에서 조회할 수 없는 키 값으로 변경
        menuToDetach.setMenuName("수박죽");
