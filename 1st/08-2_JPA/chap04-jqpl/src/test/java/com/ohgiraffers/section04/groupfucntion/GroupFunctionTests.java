package com.ohgiraffers.section04.groupfucntion;
...
public class GroupFunctionTests {
    ...
    *    따라서 반환 값을 담기 위해 선언하는 변수 타입을 기본자료형으로 하게 되면, 조회 결과를 언박싱 할 때 NPE(Null Point Exception)가 발생한다.
    * */

    @Test
    public void 특정_카텔고리의_등록된_메뉴_수_조회(){
        ...
        long countOfMenu = entityManager.createQuery(jpql, Long.class)
                .setParameter("categoryCode", categoryCodeParam).getSingleResult();
    ...
    public void groupby절과_having절을_사용한_조회_테스트() {
        ...
        //then
        Assertions.assertNotNull(sumPriceOfCategoryListToLong);
